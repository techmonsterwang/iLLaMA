...
default_cfgs = {
    # patch models
    'doit6test_small_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/doit6test_small_p16_224-15ec54c9.pth',
    ),
    'doit6test_base_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_base_p16_224-80ecf9dd.pth',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
    ),
    'doit6test_base_patch16_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_base_p16_384-83fb41ba.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit6test_base_patch32_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_base_p32_384-830016f5.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit6test_large_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_large_p16_224-4ee7a4dc.pth',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'doit6test_large_patch16_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_large_p16_384-b3be5167.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit6test_large_patch32_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit6test_large_p32_384-9b920ba8.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit6test_huge_patch16_224': _cfg(),
    'doit6test_huge_patch32_384': _cfg(input_size=(3, 384, 384)),
    # hybrid models
    'doit6test_small_resnet26d_224': _cfg(),
    'doit6test_small_resnet50d_s3_224': _cfg(),
    'doit6test_base_resnet26d_224': _cfg(),
    'doit6test_base_resnet50d_224': _cfg(),
}
...
def apply_rotary_emb(
    ...
    # print('freqs_cis:', freqs_cis.dtype)
...
class Attention(nn.Module):
    ...
    def forward(self, x: torch.Tensor, freqs_cis: torch.Tensor, mask: Optional[torch.Tensor]):
        ...
        q, k, v = qkv[0], qkv[1], qkv[2]   # make torchscript happy (cannot use tensor as tuple) # [B, N, self.num_heads, C // self.num_heads], float32

        # print('q_shape:', q.shape)  # [B, 197, 3, 64], float32
        # print('q_shape:', q.dtype)  
        q, k = apply_rotary_emb(q, k, freqs_cis=freqs_cis)  # [B, 197, 3, 64], float32
...
@register_model
def doit6test_tiny(pretrained=False, **kwargs):
...
@register_model
def doit6test_small(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit6test_base(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit6test_large(pretrained=False, **kwargs):
    model = VisionTransformer(
