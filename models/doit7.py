...
default_cfgs = {
    # patch models
    'doit7_small_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/doit7_small_p16_224-15ec54c9.pth',
    ),
    'doit7_base_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_base_p16_224-80ecf9dd.pth',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5),
    ),
    'doit7_base_patch16_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_base_p16_384-83fb41ba.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit7_base_patch32_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_base_p32_384-830016f5.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit7_large_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_large_p16_224-4ee7a4dc.pth',
        mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)),
    'doit7_large_patch16_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_large_p16_384-b3be5167.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit7_large_patch32_384': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_doit7_large_p32_384-9b920ba8.pth',
        input_size=(3, 384, 384), mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5), crop_pct=1.0),
    'doit7_huge_patch16_224': _cfg(),
    'doit7_huge_patch32_384': _cfg(input_size=(3, 384, 384)),
    # hybrid models
    'doit7_small_resnet26d_224': _cfg(),
    'doit7_small_resnet50d_s3_224': _cfg(),
    'doit7_base_resnet26d_224': _cfg(),
    'doit7_base_resnet50d_224': _cfg(),
}
...
@register_model
def doit7_femto(pretrained=False, **kwargs):
...
@register_model
def doit7_nano(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit7_tiny(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit7_small(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit7_base(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def doit7_large(pretrained=False, **kwargs):
    model = VisionTransformer(
