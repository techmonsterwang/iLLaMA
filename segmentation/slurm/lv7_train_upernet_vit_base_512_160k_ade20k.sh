...
PRETRAINED=/mnt/petrelfs/wangjiahao/DoiT/pretrained/vit-base-in1k-81.4.pth
WORD_DIR=work_dirs/lv7_train_upernet_vit_base_512_160k_ade20k
GPUS=8
PORT=${PORT:-29273}

PYTHONPATH="$(dirname $0)/..":$PYTHONPATH \
srun -p eval \
    --job-name=lv7_train_upernet_vit_base_512_160k_ade20k \
    --gres=gpu:8 \
    --cpus-per-task=32 \
    --preempt \
    --quotatype=reserved \
