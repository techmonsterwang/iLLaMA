...
PRETRAINED=/mnt/petrelfs/wangjiahao/DoiT/pretrained/vit-tiny-in1k-73.8.pth
WORD_DIR=work_dirs/lv8_train_upernet_vit_tiny_512_160k_ade20k
GPUS=8
PORT=${PORT:-29278}

PYTHONPATH="$(dirname $0)/..":$PYTHONPATH \
srun -p eval \
    --job-name=lv8_train_upernet_vit_tiny_512_160k_ade20k \
    --gres=gpu:8 \
    --cpus-per-task=32 \
    --preempt \
    --quotatype=reserved \
